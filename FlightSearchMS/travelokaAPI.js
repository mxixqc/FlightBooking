	...
	const response = await fetch(
		"https://m.traveloka.com/api/v2/flight/search/oneway",
		{
			...
			body: `{"fields":[],"clientInterface":"mobile","data":{"currency":"SGD","isReschedule":false,"locale":"en_SG","numSeats":{"numAdults":${parseInt(
				...
				infants
			)}},"seatPublishedClass":"${seatClass.toUpperCase()}","destinationAirportOrArea":"${dAP}","flexibleTicket":false,"flightDate":{"year":${parseInt(flightDate[0])},"month":${parseInt(flightDate[1])},"day":${parseInt(flightDate[2])}},"sourceAirportOrArea":"${sAP}","newResult":true,"seqNo":null,"searchId":"58a87e03-fbe4-4f4b-8d89-828480999d3d","visitId":"8a6d27c5-1f4e-4de2-aec0-25214645f73b","utmId":null,"utmSource":null,"searchSpecRoutesTotal":1}}`,
			method: "POST",
		}
	);
