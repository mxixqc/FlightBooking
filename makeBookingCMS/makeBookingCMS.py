...
def makeBooking():
    ...
    if request.is_json:
        try:
            ...
            bookingStatus = sendBookingDetails(inputBookingDetails)
            print('bookingStatus type ', bookingStatus)
...
def sendBookingDetails(bookingDetails):
    ...
    # URL for bookingMS
    bookingMSURL = "http://booking:5000/api/bookings"
